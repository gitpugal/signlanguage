...
def main():
    ...
    # print("\n")
    # predType = input(
    #     "Press 1 for webcam prediction and 2 for pre-recorded video prediction: "
    # )
    st.set_page_config(page_title="Sign Language Detection")
    st.title("Indian Sign Language Detection")
    st.caption("by Pugalarasan, Hari Gokul and Abdullah")
    # cap_device = args.device for webcam prediction
    # if predType != "1":
    #     cap_device = "E:\shadow\Pictures\Camera Roll\\newpred.mp4"
    # else:
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            ...
            for hand_landmarks, handedness in zip(
                ...
                if (
                    hand_sign_id != -1
                    and keypoint_classifier_labels[hand_sign_id] != prev
                ):
                    prev = keypoint_classifier_labels[hand_sign_id]
